...
1. You provide a company URL and name.
2. The app scrapes the landing page and relevant internal links.
3. It builds a brochure using Gemini (gemini-1.5-flash) via OpenAI SDK.
4. You can also chat with a local model (LLaMA3 via Ollama).
5. The assistant dynamically uses tools when needed (like `get_brochure` or `todays_date`).
